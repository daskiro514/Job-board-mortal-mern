...
import DashboardCalendarHeader from './DashboardCalendarHeader';
...
function DashboardCalendar(props) {
	...
	return (
		<div className={clsx(classes.root, 'flex flex-col flex-auto relative')}>
			<DashboardCalendarHeader calendarRef={calendarRef} currentDate={currentDate} />
...
export default withReducer('calendarApp', reducer)(DashboardCalendar);
